///draw_text_outline(x,y,str,outwidth,outcol,outfidelity,scaleX,scaleY,angle)
...
{
    draw_text_transformed(argument0+lengthdir_x(argument3,dto_i),argument1+lengthdir_y(argument3,dto_i),argument2,argument6,argument7,argument8);
}
